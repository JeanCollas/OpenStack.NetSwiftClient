...
namespace NetSwiftClient.Demo.AspNetCore
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Transient : new object for each injection
            ...
            if(!swiftConfig.AuthUrl.IsNullOrEmpty())
                // Register config only if it exists
                services.AddSingleton(swiftConfig);

            services.AddScoped<SwiftClientService>();
