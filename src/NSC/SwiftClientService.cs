...
namespace NetSwiftClient
{
    public class SwiftClientService : SwiftClient
    {
        ...
        public Task<SwiftBaseResponse> AccountPostAsync(Dictionary<string, string> metaValues = null,
        ...
        public Task<SwiftBaseResponse> ContainerPostAsync(string container,
        ...
        public string ObjectGetTmpUrlAsync(string container, string objectName, TimeSpan expiresIn,
            string objectStoreKey, string fileName = null, string ipRange = null, bool? noDownloadButInline = null)
            => ObjectGetTmpUrlAsync(Config.ObjectStoreUrl, container, objectName, expiresIn, objectStoreKey, fileName,
                ipRange, noDownloadButInline);
        ...
        public Task<SwiftBaseResponse> ObjectPostAsync(string container, string objectName,
            Dictionary<string, string> metaValues = null, Dictionary<string, string> additionalHeaders = null)
